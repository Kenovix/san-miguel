...
#Layer1
{
   ...
   background-image: url(images/Servicios_Layer1_bkgrnd.png);
...
<div id="space"><br></div>
<div id="container">
<div id="wb_Image3" style="position:absolute;left:340px;top:70px;width:265px;height:269px;z-index:51;">
<a href="./Servicios.php"><img src="images/img0026.png" id="Image3" alt=""></a></div>
<div id="wb_Image2" style="position:absolute;left:840px;top:78px;width:128px;height:128px;z-index:52;">
<a href="./Egresos2.php"><img src="images/img0035.png" id="Image2" alt=""></a></div>
<div id="Layer2" style="position:absolute;text-align:left;left:35px;top:358px;width:903px;height:1066px;z-index:53;">
...
$reg = mysql_query("SELECT * FROM `proveedores` WHERE `Servicios_Publicos`='1' ",$con) or die("La consulta a cuentasfrecuentes es erronea.".mysql_error());
...
<div id="wb_Image4" style="position:absolute;left:0px;top:68px;width:115px;height:62px;z-index:54;">
<img src="images/tslogo.png" id="Image4" alt=""></div>
<div id="wb_Image5" style="position:absolute;left:684px;top:297px;width:350px;height:350px;z-index:55;">
<img src="images/mensaje3.png" id="Image5" alt=""></div>
<iframe name="FrameMensajes" id="InlineFrame1" style="position:absolute;left:753px;top:384px;width:210px;height:157px;z-index:56;" src="http://" frameborder="0"></iframe>
</div>
