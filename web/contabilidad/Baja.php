...
{
   background-color: transparent;
   background-image: url(images/Baja_Layer1_bkgrnd.png);
...
#Button2
{
   border: 1px #A9A9A9 solid;
   background-color: transparent;
   background-image: url(images/Baja_Button2_bkgrnd.png);
   background-repeat: repeat-x;
   background-position: left top;
   color: #FFFFFF;
   font-family: Arial;
...
<body>
<div id="jQueryTabs1" style="position:absolute;left:159px;top:64px;width:1167px;z-index:13;">
<ul>
<li><a href="#jquerytabs1-page-0"><span>Dar de Baja</span></a></li>
</ul>
<div style="height:707px;overflow:auto;padding:0;" id="jquerytabs1-page-0">
<iframe name="FrameProducto" id="InlineFrame4" style="position:absolute;left:10px;top:125px;width:1143px;height:602px;z-index:3;" src="" frameborder="0"></iframe>
<div id="wb_Form1" style="position:absolute;left:351px;top:53px;width:422px;height:65px;z-index:4;">
<form name="Form1" method="post" action="BuscarProductoBaja.php" enctype="multipart/form-data" target="FrameProducto" id="Form1">
<input type="text" id="Editbox1" style="position:absolute;left:13px;top:30px;width:267px;height:19px;line-height:19px;z-index:0;" name="TxtBusqueda" value="" placeholder="Digite alg&#250;n dato asociado al producto">
...
<div id="wb_Text1" style="position:absolute;left:39px;top:9px;width:228px;height:16px;text-align:center;z-index:2;">
<span style="color:#0000FF;font-family:'Bookman Old Style';font-size:13px;"><strong><em>Busque el producto</em></strong></span></div>
</form>
</div>
</div>
</div>
<div id="Layer2" style="position:absolute;text-align:right;left:0px;top:0px;width:159px;height:101%;z-index:14;">
...
<ul>
<li class="firstitem"><a class="active" href="./Baja.php" target="_self">Bajas</a>
</li>
...
<a href="http://www.technosoluciones.com/" target="_blank"><img src="images/img0055.png" id="Image11" alt=""></a></div>
</div>
</div>
<div id="Layer1" style="position:absolute;text-align:left;left:0px;top:0px;width:100%;height:64px;z-index:15;">
<div id="wb_Image23" style="position:absolute;left:981px;top:1px;width:125px;height:50px;z-index:7;">
