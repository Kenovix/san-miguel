...
////////////////////////////////////////////
		  $sel1=mysql_query("SELECT * FROM egresos WHERE idEgresos='$idEgresos'") or die("problemas con la consulta a egresos");
...
$Valor=number_format($DatosEgreso["Valor"]);
...
<span style="color:#000000;font-family:'Bookman Old Style';font-size:13px;">Guadalajara de Buga $DatosEgreso[Fecha]</span></div>
...
<span style="color:#000000;font-family:'Bookman Old Style';font-size:13px;"><strong><em>Cancelado a: $DatosEgreso[Beneficiario] </em></strong></span></div>
<div id="wb_Text2" style="position:absolute;left:37px;top:106px;width:150px;height:16px;z-index:4;text-align:left;">
<span style="color:#000000;font-family:'Bookman Old Style';font-size:13px;"><strong><em>NIT: $DatosEgreso[NIT]</em></strong></span></div>

<div id="wb_Text4" style="position:absolute;left:41px;top:110px;width:368px;height:18px;z-index:6;text-align:left;">
<span style="color:#000000;font-family:'Bookman Old Style';font-size:13px;"><strong><em>Dirección: $DatosEgreso[Direccion]</em></strong></span></div>
...
<div id="wb_Text6" style="position:absolute;left:35px;top:150px;width:242px;height:18px;z-index:8;text-align:left;">
<span style="color:#00008B;font-family:'Bookman Old Style';font-size:13px;"><strong><em>Valor:</em></strong></span><span style="color:#000000;font-family:'Bookman Old Style';font-size:13px;"> $Valor </span></div>
