...
<span style="color:#00008B;font-family:'Bookman Old Style';font-size:10px;"><strong><em>BALANCE DE COMPROBACION
</em></strong></span><BR>
...
$sel1=mysql_query("SELECT substring(CuentaPUC,1,4) as Cuenta, SUM(Debito) as SumDebito, SUM(Credito) as SumCredito FROM librodiario WHERE Fecha >= '$FechaIni' AND Fecha <= '$FechaFinal' $Condicion 
...
$TotalDebito=number_format($TotalDebitos);
$TotalCredito=number_format($TotalCreditos);
