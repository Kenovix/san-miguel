...
if($CentroCostos=="ALL")
	...
	$Condicion="AND f.CentroCosto='$CentroCostos'";
////////////////////////////////////////////
/////////////Me conecto a la db
////////////////////////////////////////////
...
WHERE f.Fecha >= '$FechaIni' AND f.Fecha <= '$FechaFinal' $Condicion
...
WHERE f.Fecha >= '$FechaIni' AND f.Fecha <= '$FechaFinal' $Condicion",$con) or die("problemas con la consulta a join ventas ".mysql_error());
