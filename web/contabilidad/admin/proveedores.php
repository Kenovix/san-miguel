 ...
 */
    ...
    class proveedoresPage extends Page
    {
        protected function DoBeforeCreate()
        {
            ...
            $field->SetIsNotNull(true);
            $this->dataset->AddField($field, false);
            $field = new IntegerField('almacen_id');
            $field->SetIsNotNull(true);
            $this->dataset->AddField($field, false);
            ...
            $this->dataset->AddLookupField('almacen_id', 'almacen', new IntegerField('id', null, null, true), new StringField('nombre', 'almacen_id_nombre', 'almacen_id_nombre_almacen'), 'almacen_id_nombre_almacen');
        }
        ...
        protected function CreateGridAdvancedSearchControl(Grid $grid)
        {
            ...
            $lookupDataset->AddField($field, false);
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateLookupSearchInput('almacen_id', $this->RenderText('Almacen Id'), $lookupDataset, 'id', 'nombre', false));
        }
        ...
        protected function AddFieldColumns(Grid $grid)
        {
            ...
            // View column for nombre field
            //
            $column = new TextViewColumn('almacen_id_nombre', 'Almacen Id', $this->dataset);
            $column->SetOrderable(true);
            
            /* <inline edit column> */
            //
            // Edit column for almacen_id field
            //
            $editor = new ComboBox('almacen_id_edit', $this->GetLocalizerCaptions()->GetMessageString('PleaseSelect'));
            $lookupDataset = new TableDataset(
                new MyConnectionFactory(),
                GetConnectionOptions(),
                '`almacen`');
