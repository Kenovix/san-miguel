 ...
 */
    ...
    class cod_paisesPage extends Page
    {
        ...
        {
            $grid->UseFilter = true;
            $grid->SearchControl = new SimpleSearch('cod_paisesssearch', $this->dataset,
                array('Codigo', 'Pais'),
                array($this->RenderText('Codigo'), $this->RenderText('Pais')),
                array(
        ...
        {
            $this->AdvancedSearchControl = new AdvancedSearchControl('cod_paisesasearch', $this->dataset, $this->GetLocalizerCaptions(), $this->GetColumnVariableContainer(), $this->CreateLinkBuilder());
        ...
        protected function AddFieldColumns(Grid $grid)
        {
            ...
            $column->SetFullTextWindowHandlerName('Pais_handler');
        ...
        {
            $result = new Grid($this, $this->dataset, 'cod_paisesGrid');
            ...
            $column->SetInsertOperationColumn($editColumn);
            /* </inline insert column> */
            $handler = new ShowTextBlobHandler($this->dataset, $this, 'Pais_handler', $column);
    ...
    try
    {
        $Page = new cod_paisesPage("cod_paises.php", "cod_paises", GetCurrentUserGrantForDataSource("cod_paises"), 'UTF-8');
        $Page->SetShortCaption('Cod Paises');
        $Page->SetHeader(GetPagesHeader());
        $Page->SetFooter(GetPagesFooter());
        $Page->SetCaption('Cod Paises');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("cod_paises"));
