 ...
 */
    ...
    class cod_departamentosPage extends Page
    {
        ...
        {
            $grid->UseFilter = true;
            $grid->SearchControl = new SimpleSearch('cod_departamentosssearch', $this->dataset,
                array('Cod_dpto', 'Nombre'),
                array($this->RenderText('Cod Dpto'), $this->RenderText('Nombre')),
                array(
        ...
        {
            $this->AdvancedSearchControl = new AdvancedSearchControl('cod_departamentosasearch', $this->dataset, $this->GetLocalizerCaptions(), $this->GetColumnVariableContainer(), $this->CreateLinkBuilder());
            $this->AdvancedSearchControl->setTimerInterval(1000);
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('Cod_dpto', $this->RenderText('Cod Dpto')));
        ...
        {
            $result = new Grid($this, $this->dataset, 'cod_departamentosGrid');
