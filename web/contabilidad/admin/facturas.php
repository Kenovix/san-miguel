 ...
 */
    ...
    class facturasPage extends Page
    {
        protected function DoBeforeCreate()
        {
            ...
            $field->SetIsNotNull(true);
            $this->dataset->AddField($field, false);
            $field = new StringField('ObservacionesFact');
            $field->SetIsNotNull(true);
            $this->dataset->AddField($field, false);
            $field = new IntegerField('CentroCosto');
            $this->dataset->AddField($field, false);
            $this->dataset->AddLookupField('CentroCosto', 'servicio', new IntegerField('id', null, null, true), new StringField('nombre', 'CentroCosto_nombre', 'CentroCosto_nombre_servicio'), 'CentroCosto_nombre_servicio');
        }
        ...
        protected function CreateGridAdvancedSearchControl(Grid $grid)
        {
            ...
            $field->SetIsNotNull(true);
            $lookupDataset->AddField($field, false);
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateLookupSearchInput('CentroCosto', $this->RenderText('CentroCosto'), $lookupDataset, 'id', 'nombre', false));
        }
        ...
        protected function AddFieldColumns(Grid $grid)
        {
            ...
            //
            $column = new TextViewColumn('CentroCosto_nombre', 'CentroCosto', $this->dataset);
            $column->SetOrderable(true);
