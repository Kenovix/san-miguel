 ...
 */
    ...
    class kardexmercanciasPage extends Page
    {
        ...
        {
            $grid->UseFilter = true;
            $grid->SearchControl = new SimpleSearch('kardexmercanciasssearch', $this->dataset,
        ...
        {
            $this->AdvancedSearchControl = new AdvancedSearchControl('kardexmercanciasasearch', $this->dataset, $this->GetLocalizerCaptions(), $this->GetColumnVariableContainer(), $this->CreateLinkBuilder());
        ...
        {
            $result = new Grid($this, $this->dataset, 'kardexmercanciasGrid');
    ...
    try
    {
        $Page = new kardexmercanciasPage("kardexmercancias.php", "kardexmercancias", GetCurrentUserGrantForDataSource("kardexmercancias"), 'UTF-8');
        $Page->SetShortCaption('Kardexmercancias');
        $Page->SetHeader(GetPagesHeader());
        $Page->SetFooter(GetPagesFooter());
        $Page->SetCaption('Kardexmercancias');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("kardexmercancias"));
