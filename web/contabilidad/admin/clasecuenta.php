 ...
 */
    ...
    class clasecuentaPage extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->dataset = new TableDataset(
                ...
                '`clasecuenta`');
            $field = new StringField('PUC');
            $field->SetIsNotNull(true);
            $this->dataset->AddField($field, true);
            $field = new StringField('Clase');
        ...
        {
            $grid->UseFilter = true;
            $grid->SearchControl = new SimpleSearch('clasecuentassearch', $this->dataset,
                array('PUC', 'Clase', 'Valor'),
                array($this->RenderText('PUC'), $this->RenderText('Clase'), $this->RenderText('Valor')),
                array(
        ...
        {
            $this->AdvancedSearchControl = new AdvancedSearchControl('clasecuentaasearch', $this->dataset, $this->GetLocalizerCaptions(), $this->GetColumnVariableContainer(), $this->CreateLinkBuilder());
            $this->AdvancedSearchControl->setTimerInterval(1000);
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('PUC', $this->RenderText('PUC')));
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('Clase', $this->RenderText('Clase')));
        ...
        {
            //
            // View column for PUC field
            //
            $column = new TextViewColumn('PUC', 'PUC', $this->dataset);
            $column->SetOrderable(true);
            
            /* <inline edit column> */
            //
            // Edit column for PUC field
            //
            $editor = new TextEdit('puc_edit');
            $editor->SetSize(45);
            $editor->SetMaxLength(45);
            $editColumn = new CustomEditColumn('PUC', 'PUC', $editor, $this->dataset);
            ...
            //
            $column = new TextViewColumn('Clase', 'Clase', $this->dataset);
            $column->SetOrderable(true);
        ...
        {
            $result = new Grid($this, $this->dataset, 'clasecuentaGrid');
    ...
    try
    {
        $Page = new clasecuentaPage("clasecuenta.php", "clasecuenta", GetCurrentUserGrantForDataSource("clasecuenta"), 'UTF-8');
        $Page->SetShortCaption('Clasecuenta');
        $Page->SetHeader(GetPagesHeader());
        $Page->SetFooter(GetPagesFooter());
        $Page->SetCaption('Clasecuenta');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("clasecuenta"));
