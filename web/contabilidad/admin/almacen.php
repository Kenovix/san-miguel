 ...
 */
    ...
    class almacenPage extends Page
    {
        ...
        {
            $grid->UseFilter = true;
            $grid->SearchControl = new SimpleSearch('almacenssearch', $this->dataset,
                array('id', 'nombre', 'empresa_id'),
                array($this->RenderText('Id'), $this->RenderText('Nombre'), $this->RenderText('Empresa Id')),
                array(
        ...
        {
            $this->AdvancedSearchControl = new AdvancedSearchControl('almacenasearch', $this->dataset, $this->GetLocalizerCaptions(), $this->GetColumnVariableContainer(), $this->CreateLinkBuilder());
        ...
        {
            $result = new Grid($this, $this->dataset, 'almacenGrid');
    ...
    try
    {
        $Page = new almacenPage("almacen.php", "almacen", GetCurrentUserGrantForDataSource("almacen"), 'UTF-8');
        $Page->SetShortCaption('Almacen');
        $Page->SetHeader(GetPagesHeader());
        $Page->SetFooter(GetPagesFooter());
        $Page->SetCaption('Almacen');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("almacen"));
