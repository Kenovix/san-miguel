 ...
 */
    ...
    class servicioPage extends Page
    {
        ...
        {
            $grid->UseFilter = true;
            $grid->SearchControl = new SimpleSearch('serviciossearch', $this->dataset,
                array('id', 'empresa_id', 'nombre', 'estado'),
                array($this->RenderText('Id'), $this->RenderText('Empresa Id'), $this->RenderText('Nombre'), $this->RenderText('Estado')),
                array(
        ...
        {
            $this->AdvancedSearchControl = new AdvancedSearchControl('servicioasearch', $this->dataset, $this->GetLocalizerCaptions(), $this->GetColumnVariableContainer(), $this->CreateLinkBuilder());
        ...
        {
            $result = new Grid($this, $this->dataset, 'servicioGrid');
    ...
    try
    {
        $Page = new servicioPage("servicio.php", "servicio", GetCurrentUserGrantForDataSource("servicio"), 'UTF-8');
        $Page->SetShortCaption('Servicio');
        $Page->SetHeader(GetPagesHeader());
        $Page->SetFooter(GetPagesFooter());
        $Page->SetCaption('Servicio');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("servicio"));
