...
#Button2
{
   ...
   background-color: transparent;
   background-image: url(images/PagarCuentas_Button2_bkgrnd.png);
...
#AdvancedButton1
{
   border: 1px #A9A9A9 solid;
   background-color: transparent;
   background-image: url(images/PagarCuentas_AdvancedButton1_bkgrnd.png);
   background-repeat: repeat-x;
   background-position: left top;
}
#Layer2
...
{
   background-color: transparent;
   background-image: url(images/PagarCuentas_Layer1_bkgrnd.png);
   background-repeat: repeat-x;
   background-position: left top;
}
#Image23
...
<body>
<div id="jQueryTabs1" style="position:absolute;left:172px;top:77px;width:1173px;z-index:14;">
<ul>
<li><a href="#jquerytabs1-page-0"><span>Cuentas por pagar</span></a></li>
</ul>
<div style="height:788px;overflow:auto;padding:0;" id="jquerytabs1-page-0">
<div id="wb_Text12" style="position:absolute;left:496px;top:63px;width:324px;height:16px;z-index:2;text-align:left;">
<span style="color:#0000FF;font-family:'Bookman Old Style';font-size:13px;"><strong><em>Seleccione la cuenta origen del pago</em></strong></span></div>
<div id="wb_Form2" style="position:absolute;left:12px;top:63px;width:268px;height:81px;z-index:3;">
<form name="Form1" method="post" action="funciones.php" enctype="multipart/form-data" target="InlineFrame1" id="Form2">
<input type="submit" id="Button2" name="BtnPagaCuenta" value="Actualizar Alertas" style="position:absolute;left:65px;top:53px;width:147px;height:22px;z-index:0;">
<div id="wb_Text3" style="position:absolute;left:42px;top:12px;width:203px;height:32px;text-align:center;z-index:1;">
<span style="color:#0000FF;font-family:'Bookman Old Style';font-size:13px;"><strong><em>Por favor oprima el boton para actualizar las alertas</em></strong></span></div>
</form>
</div>
<div id="Html2" style="position:absolute;left:524px;top:90px;width:210px;height:42px;z-index:4">
<?php

$con=mysql_connect($host,$user,$pw) or die("problemas con el servidor");
mysql_select_db($db,$con) or die("la base de datos no abre");

print("<form name='formIngFact' method='post' action='PagarCuenta.php' target=InlineFrame1 >
...
echo '</form>';
?></div>
<iframe name="InlineFrame1" id="InlineFrame1" style="position:absolute;left:12px;top:180px;width:1150px;height:613px;z-index:5;" src="PagarCuenta.php" frameborder="0"></iframe>
<button id="AdvancedButton1" type="button" style="position:absolute;left:993px;top:101px;width:158px;height:25px;z-index:6;" onclick="window.location.reload()" name="" value="">
<div style="text-align:center"><span style="color:#FFFFFF;font-family:'Bookman Old Style';font-size:13px"><b><i>Actualizar página</i></b></span></div>
</button>
</div>
</div>
...
<div id="wb_CssMenu1" style="position:absolute;left:6px;top:189px;width:138px;height:455px;z-index:9;">
<ul>
...
<li><a class="active" href="./PagarCuentas.php" target="_self">CuentasXPagar</a>
</li>
...
<div id="wb_Image11" style="position:absolute;left:14px;top:92px;width:120px;height:48px;z-index:10;">
<a href="http://www.technosoluciones.com/" target="_blank"><img src="images/img0042.png" id="Image11" alt=""></a></div>
</div>
</div>
<div id="Layer1" style="position:absolute;text-align:left;left:0px;top:0px;width:100%;height:64px;z-index:16;">
<div id="wb_Image23" style="position:absolute;left:981px;top:1px;width:125px;height:50px;z-index:11;">
<a href="http://www.technosoluciones.com" target="_blank"><img src="images/header-logo.png" id="Image23" alt=""></a></div>
<div id="Html1" style="position:absolute;left:6px;top:18px;width:627px;height:33px;z-index:12">
<?php
...
?></div>
<div id="wb_JavaScript2" style="position:absolute;left:654px;top:22px;width:191px;height:28px;z-index:13;">
