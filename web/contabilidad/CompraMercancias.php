...
#Layer1
{
   ...
   background-image: url(images/CompraMercancias_Layer1_bkgrnd.png);
...
$(document).ready(function()
{
   var jQueryToolTip1Opts =
   {
      hide: 'slideUp',
      show: 'slideDown',
      content: '<span style="color:#000000;font-family:\'MS Shell Dlg\';font-size:11px;">Digita el Subtotal de la compra, si no se pagó IVA será igual que el total</span>',
      items: '#Editbox2',
   ...
   var jQueryToolTip2Opts =
   {
      hide: 'slideUp',
      show: 'slideDown',
      content: '<span style="color:#000000;font-family:\'MS Shell Dlg\';font-size:11px;">Si no se paga IVA, por favor deja en blanco o escribe un Cero</span>',
      items: '#Editbox3',
      position: { my: "right bottom", at: "left top", collision: "flipfit" }
   };
   ...
   var jQueryToolTip3Opts =
   {
      hide: 'slideUp',
      show: 'slideDown',
      content: '<span style="color:#000000;font-family:\'MS Shell Dlg\';font-size:11px;">Si no se paga IVA, este Valor debe ser igual al Subtotal</span>',
      items: '#Editbox4',
      position: { my: "right bottom", at: "left top", collision: "flipfit" }
   };
   ...
   var jQueryToolTip4Opts =
   {
      hide: 'slideUp',
      show: 'slideDown',
      content: '<span style="color:#000000;font-family:\'MS Shell Dlg\';font-size:11px;">Si no aparece Ningun Proveedor por favor crea uno con clasificacion &quot;VARIOS&quot;</span>',
      items: '#wb_Image6',
      position: { my: "right bottom", at: "left top", collision: "flipfit" }
   };
   ...
   var jQueryToolTip5Opts =
   {
      hide: 'slideUp',
      show: 'slideDown',
      content: '<span style="color:#000000;font-family:\'MS Shell Dlg\';font-size:11px;">Recuerda que debes ingresarlo al Kardex una vez realizada la compra</span>',
      items: '#Combobox1',
      position: { my: "right bottom", at: "left top", collision: "flipfit" }
   };
   $("#Combobox1").tooltip(jQueryToolTip5Opts);
});
</script>
...
<div id="space"><br></div>
<div id="container">
<div id="wb_Image3" style="position:absolute;left:324px;top:68px;width:290px;height:290px;z-index:67;">
<a href="./CompraMercancias.php"><img src="images/img0014.png" id="Image3" alt=""></a></div>
<div id="wb_Image2" style="position:absolute;left:840px;top:78px;width:128px;height:128px;z-index:68;">
<a href="./Egresos2.php"><img src="images/img0041.png" id="Image2" alt=""></a></div>
<div id="Layer2" style="position:absolute;text-align:left;left:35px;top:358px;width:903px;height:876px;z-index:69;">
<div id="wb_Form1" style="position:absolute;left:15px;top:16px;width:634px;height:839px;z-index:33;">
...
<input type="hidden" name="TxtCompraMercancias" value="1">
...
<div id="wb_Text2" style="position:absolute;left:9px;top:274px;width:287px;height:24px;text-align:center;z-index:4;">
<span style="color:#000000;font-family:'Trebuchet MS';font-size:19px;"><em>Seleccione el tipo de compra</em></span><span style="color:#FF0000;font-family:'Trebuchet MS';font-size:19px;"><em>*</em></span></div>
...
<input type="number" id="Editbox4" style="position:absolute;left:300px;top:518px;width:233px;height:37px;line-height:37px;z-index:8;" name="TxtValor" value="" required placeholder="Digite el total del pago">
<div id="wb_Text5" style="position:absolute;left:211px;top:529px;width:84px;height:24px;text-align:center;z-index:9;">
<span style="color:#000000;font-family:'Trebuchet MS';font-size:19px;"><em>Total</em></span><span style="color:#FF0000;font-family:'Trebuchet MS';font-size:19px;"><em>*</em></span></div>
...
<input type="text" id="Editbox1" style="position:absolute;left:299px;top:374px;width:272px;height:26px;line-height:26px;z-index:12;" name="TxtNumFactura" value="" placeholder="Digite el numero de factura">
<div id="wb_Text6" style="position:absolute;left:84px;top:378px;width:205px;height:24px;text-align:center;z-index:13;">
<span style="color:#000000;font-family:'Trebuchet MS';font-size:19px;"><em>Numero de la factura</em></span><span style="color:#FF0000;font-family:'Trebuchet MS';font-size:19px;"><em>*</em></span></div>
<div id="wb_Text7" style="position:absolute;left:30px;top:192px;width:255px;height:48px;text-align:center;z-index:14;">
<span style="color:#000000;font-family:'Trebuchet MS';font-size:19px;"><em>Seleccione el proveedor para esta compra</em></span><span style="color:#FF0000;font-family:'Trebuchet MS';font-size:19px;"><em>*</em></span></div>
<input type="number" id="Editbox3" style="position:absolute;left:300px;top:472px;width:233px;height:37px;line-height:37px;z-index:15;" name="TxtIVA" value="" required placeholder="IVA si aplica">
<input type="number" id="Editbox2" style="position:absolute;left:300px;top:426px;width:233px;height:37px;line-height:37px;z-index:16;" name="TxtSubtotal" value="" required placeholder="Subtotal de la compra">
<div id="wb_Text8" style="position:absolute;left:182px;top:436px;width:107px;height:24px;text-align:center;z-index:17;">
<span style="color:#000000;font-family:'Trebuchet MS';font-size:19px;"><em>SubTotal</em></span><span style="color:#FF0000;font-family:'Trebuchet MS';font-size:19px;"><em>*</em></span></div>
<div id="wb_Text9" style="position:absolute;left:225px;top:483px;width:60px;height:24px;text-align:center;z-index:18;">
<span style="color:#000000;font-family:'Trebuchet MS';font-size:19px;"><em>IVA</em></span></div>



<div id="wb_Image6" style="position:absolute;left:220px;top:215px;width:32px;height:32px;z-index:22;">
...
&nbsp;</div>
<input type="radio" id="RadioButton4" name="TipoPago" value="Contado" checked style="position:absolute;left:299px;top:312px;z-index:25;">
<input type="radio" id="RadioButton5" name="TipoPago" value="Programado" style="position:absolute;left:299px;top:337px;z-index:26;">
<div id="wb_Text13" style="position:absolute;left:119px;top:308px;width:177px;height:24px;text-align:center;z-index:27;">
<span style="color:#000000;font-family:'Trebuchet MS';font-size:19px;"><em>Pago de contado</em></span></div>
<div id="wb_Text14" style="position:absolute;left:114px;top:333px;width:177px;height:24px;text-align:center;z-index:28;">
<span style="color:#000000;font-family:'Trebuchet MS';font-size:19px;"><em>Pago programado</em></span></div>
<div id="Html6" style="position:absolute;left:336px;top:332px;width:113px;height:24px;z-index:29">
<?php

print('<input type="date" name="TxtFechaProgram" step="1" min="2010-01-01" max="2200-12-31" value='.$fecha.'>');

?></div>
<div id="Html2" style="position:absolute;left:296px;top:111px;width:210px;height:42px;z-index:30">
<?php
...
echo '</select><br>';
?></div>
<div id="Html5" style="position:absolute;left:296px;top:192px;width:210px;height:42px;z-index:31">
<?php
...
echo '</select><br>';
?></div>
<div id="Html3" style="position:absolute;left:296px;top:262px;width:210px;height:42px;z-index:32">
<?php
...
$reg = mysql_query("SELECT * FROM `subcuentas` WHERE `Cuentas_idPUC`='1524' ",$con) or die("La consulta a cuentasfrecuentes es erronea.".mysql_error());
...
<div id="wb_Text11" style="position:absolute;left:653px;top:818px;width:221px;height:24px;text-align:center;z-index:34;">
<span style="color:#FF0000;font-family:'Trebuchet MS';font-size:19px;"><em>* Campos obligatorios </em></span></div>
<div id="wb_Text12" style="position:absolute;left:660px;top:468px;width:221px;height:72px;text-align:center;z-index:35;">
...
<div id="wb_Image4" style="position:absolute;left:0px;top:68px;width:115px;height:62px;z-index:70;">
<img src="images/tslogo.png" id="Image4" alt=""></div>
<div id="wb_Image5" style="position:absolute;left:684px;top:297px;width:350px;height:350px;z-index:71;">
<img src="images/mensaje3.png" id="Image5" alt=""></div>
<iframe name="FrameMensajes" id="InlineFrame1" style="position:absolute;left:753px;top:384px;width:210px;height:157px;z-index:72;" src="http://" frameborder="0"></iframe>
</div>
<div id="Layer1" style="position:absolute;text-align:left;left:0px;top:0px;width:100%;height:64px;z-index:73;">
