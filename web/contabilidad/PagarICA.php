...
#Layer1
{
   ...
   background-image: url(images/PagarICA_Layer1_bkgrnd.png);
...
<div id="space"><br></div>
<div id="container">
<div id="wb_Image3" style="position:absolute;left:295px;top:78px;width:236px;height:183px;z-index:49;">
<a href="./kits.php"><img src="images/img0052.jpg" id="Image3" alt=""></a></div>
<div id="wb_Image2" style="position:absolute;left:840px;top:78px;width:128px;height:128px;z-index:50;">
<a href="./PagaImpuestos.php"><img src="images/img0071.png" id="Image2" alt=""></a></div>
...
<form name="FrmArriendos" method="post" action="GastosICA.php" enctype="multipart/form-data" target="FrameMensajes" id="Form1">
<input type="hidden" name="TxPagarICA" value="1">
...
<input type="submit" id="Button1" onclick="envia();return false;" name="BtnPagaICA" value="GuardarICA" style="position:absolute;left:453px;top:661px;width:130px;height:127px;z-index:24;">
</form>
</div>
...
<img src="images/img0072.png" id="TextArt1" alt="ICA" title="ICA" style="width:123px;height:34px;"></div>
</div>
