...
#Layer1
{
   ...
   background-image: url(images/Devoluciones_Layer1_bkgrnd.png);
...
{
   background-color: transparent;
   background-image: url(images/Devoluciones_Layer2_bkgrnd.png);
...
<li><a class="active" href="./Devoluciones.php" target="_self">Devoluciones</a>
</li>
...
<ul>
<li><a href="#jquerytabs1-page-0"><span>Devoluciones</span></a></li>
</ul>
...
<form name="FormInventarios" method="post" action="VerFacturas.php" enctype="multipart/form-data" target="InlineFrame1" id="Form1">
<input type="number" id="Editbox5" onchange="VerInv() ;return true;return false;" style="position:absolute;left:445px;top:44px;width:243px;height:30px;line-height:30px;z-index:5;" name="TxtBuscarFactura" value="" placeholder="Buscar">
<div id="wb_Text10" style="position:absolute;left:451px;top:16px;width:221px;height:16px;z-index:6;text-align:left;">
