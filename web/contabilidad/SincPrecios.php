...
{
   background-color: transparent;
   background-image: url(images/SincPrecios_Layer1_bkgrnd.png);
...
#Button1
{
   ...
   background-color: transparent;
   background-image: url(images/SincPrecios_Button1_bkgrnd.png);
...
function pregunta(){ 
    if (confirm('¿Estas seguro que deseas actualizar los precios del servidor seleccionado con los precios de este servidor?')){ 
       document.FormSinc.submit() 
...
<body>
<div id="jQueryTabs1" style="position:absolute;left:159px;top:64px;width:732px;z-index:14;">
<ul>
<li><a href="#jquerytabs1-page-0"><span>Sincronizar Precios</span></a></li>
</ul>
<div style="height:707px;overflow:auto;padding:0;" id="jquerytabs1-page-0">
<div id="wb_Form1" style="position:absolute;left:15px;top:58px;width:708px;height:150px;z-index:3;">
<form name="FormSinc" method="post" action="SinconizarPrecios.php" enctype="multipart/form-data" target="FrameProducto" id="Form1">
<div id="Html1" style="position:absolute;left:18px;top:71px;width:380px;height:42px;z-index:0">
<?php

$con=mysql_connect($host,$user,$pw) or die("problemas con el servidor");
mysql_select_db($db,$con) or die("la base de datos no abre");

print(" <select name=CmbServidor size=1 id=CmbServidor required>
	<option value=NO>Seleccione el servidor que desea actualizar</option>");
	
	
$reg = mysql_query("SELECT * FROM `servidores`",$con) or die("La consulta a cuentasfrecuentes es erronea.".mysql_error());


if(mysql_num_rows($reg)){//Si existen resultados

   while($datos=mysql_fetch_array($reg)){
      echo "<option value= $datos[idServer]>$datos[Nombre]</option>";
   }
...
echo '</select><br>';
?></div>
<div id="wb_Text1" style="position:absolute;left:263px;top:16px;width:187px;height:32px;text-align:center;z-index:1;">
<span style="color:#0000FF;font-family:'Bookman Old Style';font-size:13px;"><strong><em>Seleccione el Servidor que desea actualizar</em></strong></span></div>
<input type="submit" id="Button1" onclick="pregunta();return false;" name="BtnActualizaPrecios" value="Actualizar" style="position:absolute;left:521px;top:79px;width:175px;height:34px;z-index:2;">
</form>
</div>
<iframe name="FrameProducto" id="InlineFrame4" style="position:absolute;left:15px;top:224px;width:706px;height:485px;z-index:4;" src="" frameborder="0"></iframe>
</div>
</div>
<div id="Layer2" style="position:absolute;text-align:right;left:0px;top:0px;width:159px;height:100%;z-index:15;">
<div id="Layer2_Container" style="width:159px;position:relative;margin-left:auto;margin-right:0;text-align:left;">
<div id="wb_CssMenu1" style="position:absolute;left:6px;top:189px;width:138px;height:455px;z-index:5;">
<ul>
...
<li><a class="active" href="./SincPrecios.php" target="_self">Sincronizar</a>
</li>
...
<div id="wb_Image11" style="position:absolute;left:24px;top:84px;width:120px;height:48px;z-index:6;">
<a href="http://www.technosoluciones.com/" target="_blank"><img src="images/img0070.png" id="Image11" alt=""></a></div>
</div>
</div>
<div id="Layer1" style="position:absolute;text-align:left;left:0px;top:0px;width:100%;height:64px;z-index:16;">
<div id="wb_Image23" style="position:absolute;left:882px;top:1px;width:125px;height:50px;z-index:7;">
<a href="http://www.technosoluciones.com" target="_blank"><img src="images/header-logo.png" id="Image23" alt=""></a></div>
<div id="Html2" style="position:absolute;left:6px;top:18px;width:627px;height:33px;z-index:8">
<?php
...
?></div>
<div id="wb_JavaScript2" style="position:absolute;left:654px;top:22px;width:191px;height:28px;z-index:9;">
...
<div id="jQueryDialog1" style="z-index:17;" title="Informaci&#243;n">
<div id="wb_Text2" style="position:absolute;left:42px;top:37px;width:640px;height:42px;text-align:center;z-index:13;">
<span style="color:#000000;font-family:Tahoma;font-size:17px;"><em>Esta sección permitirá actualizar los listados de precios desde este servidor a otro que Usted seleccione, se recomienda prudencia ya que esta acción es irreversible</em></span></div>
</div>
