...
#Button1
{
   border: 1px #A9A9A9 solid;
   background-color: transparent;
   background-image: url(images/Ingresos_Button1_bkgrnd.png);
...
#Button2
{
   border: 1px #A9A9A9 solid;
   background-color: transparent;
   background-image: url(images/Ingresos_Button2_bkgrnd.png);
   background-repeat: repeat-x;
   background-position: left top;
   color: #FFFFFF;
   font-family: Arial;
...
{
   background-color: transparent;
   background-image: url(images/Ingresos_Layer1_bkgrnd.png);
   background-repeat: repeat-x;
   background-position: left top;
}
#Image23
...
<body>
<div id="jQueryTabs1" style="position:absolute;left:159px;top:64px;width:881px;z-index:23;">
<ul>
<li><a href="#jquerytabs1-page-0"><span>Asociar Factura</span></a></li>
<li><a href="#jquerytabs1-page-1"><span>Buscar Factura</span></a></li>
</ul>
<div style="height:539px;overflow:auto;padding:0;" id="jquerytabs1-page-0">
<div id="wb_Form2" style="position:absolute;left:212px;top:49px;width:422px;height:65px;z-index:3;">
<form name="Form3" method="post" action="BuscarFactIng.php" enctype="multipart/form-data" target="FrameBuscarCoti" id="Form2">
<input type="text" id="Editbox7" style="position:absolute;left:13px;top:30px;width:267px;height:19px;line-height:19px;z-index:0;" name="TxtBusqueda" value="" placeholder="Digite el numero de la Factura">
<input type="submit" id="Button1" name="Actualizar Informacion" value="Buscar" style="position:absolute;left:292px;top:27px;width:118px;height:25px;z-index:1;">
<div id="wb_Text11" style="position:absolute;left:42px;top:4px;width:267px;height:16px;z-index:2;text-align:left;">
...
<iframe name="FrameBuscarCoti" id="InlineFrame4" style="position:absolute;left:10px;top:114px;width:861px;height:449px;z-index:4;" src="http://" frameborder="0"></iframe>
<div id="wb_Image4" style="position:absolute;left:798px;top:49px;width:63px;height:63px;z-index:5;">
<a href="./Rendimientos.php"><img src="images/img0105.png" id="Image4" alt=""></a></div>
<div id="wb_Text2" style="position:absolute;left:676px;top:69px;width:122px;height:16px;z-index:6;text-align:left;">
<span style="color:#0000FF;font-family:'Bookman Old Style';font-size:13px;"><strong><em>Otros Ingresos</em></strong></span></div>
</div>
<div style="height:539px;overflow:auto;padding:0;" id="jquerytabs1-page-1">
<div id="wb_Form1" style="position:absolute;left:237px;top:49px;width:422px;height:65px;z-index:10;">
<form name="Form3" method="post" action="BuscarFact.php" enctype="multipart/form-data" target="FrameBuscarFact" id="Form1">
<input type="text" id="Editbox1" style="position:absolute;left:13px;top:30px;width:267px;height:19px;line-height:19px;z-index:7;" name="TxtBusqueda" value="" placeholder="Digite alg&#250;n dato asociado a la factura">
<input type="submit" id="Button2" name="Actualizar Informacion" value="Buscar" style="position:absolute;left:292px;top:27px;width:118px;height:25px;z-index:8;">
<div id="wb_Text1" style="position:absolute;left:35px;top:5px;width:345px;height:16px;z-index:9;text-align:left;">
<span style="color:#0000FF;font-family:'Bookman Old Style';font-size:13px;"><strong><em>Digite cualquier dato asociado a la factura</em></strong></span></div>
</form>
</div>
<iframe name="FrameBuscarFact" id="InlineFrame1" style="position:absolute;left:13px;top:116px;width:861px;height:387px;z-index:11;" src="http://" frameborder="0"></iframe>
</div>
</div>
...
<li><a class="withsubmenu active" href="./Ingresos.php" target="_self">Ingresos</a>
...
<div id="wb_Image11" style="position:absolute;left:15px;top:92px;width:120px;height:48px;z-index:19;">
<a href="http://www.technosoluciones.com/" target="_blank"><img src="images/img0040.png" id="Image11" alt=""></a></div>
</div>
</div>
