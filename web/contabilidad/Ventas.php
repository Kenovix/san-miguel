...
{
   background-color: transparent;
   background-image: url(images/Ventas_Layer1_bkgrnd.png);
...
{
   background-color: transparent;
   background-image: url(images/Ventas_Layer2_bkgrnd.png);
...
<body>
<div id="Layer3" style="position:absolute;overflow:auto;text-align:left;left:3px;top:2px;width:97%;height:99%;z-index:22;">
<div id="wb_Text1" style="position:absolute;left:460px;top:65px;width:70px;height:24px;z-index:1;text-align:left;">
<span style="color:#000000;font-family:'Trebuchet MS';font-size:19px;"><em>Ventas</em></span></div>
<div id="wb_Image3" style="position:absolute;left:201px;top:126px;width:110px;height:110px;z-index:2;">
<a href="./Vender.php" target="_blank"><img src="images/img0027.png" id="Image3" alt=""></a></div>
<div id="wb_Text2" style="position:absolute;left:201px;top:265px;width:112px;height:24px;text-align:center;z-index:3;">
<span style="color:#000000;font-family:'Trebuchet MS';font-size:19px;"><em>Vender </em></span></div>
<div id="wb_Image4" style="position:absolute;left:436px;top:363px;width:117px;height:117px;z-index:4;">
<a href="VAtencion/VentaFacil.php" target="_blank"><img src="images/img0028.png" id="Image4" alt=""></a></div>
<div id="wb_Text3" style="position:absolute;left:430px;top:480px;width:150px;height:24px;text-align:center;z-index:5;">
<span style="color:#000000;font-family:'Trebuchet MS';font-size:19px;"><em>Ventas Rapidas</em></span></div>
<div id="wb_Form1" style="position:absolute;left:586px;top:85px;width:240px;height:196px;z-index:6;">
<form name="FormPrinFact" method="post" action="printer/imprimir.php" enctype="multipart/form-data" target="_blank" id="Form1">
<input type="number" id="Editbox1" style="position:absolute;left:53px;top:15px;width:162px;height:32px;line-height:32px;z-index:0;" name="print" value="" placeholder="Numero de factura">
</form>
</div>
<div id="wb_Text4" style="position:absolute;left:661px;top:258px;width:119px;height:48px;text-align:center;z-index:7;">
<span style="color:#000000;font-family:'Trebuchet MS';font-size:19px;"><em>Imprimir una factura</em></span></div>
<div id="wb_Image6" style="position:absolute;left:436px;top:120px;width:130px;height:138px;z-index:8;">
<a href="./Cotizar.php" target="_blank"><img src="images/img0034.png" id="Image6" alt=""></a></div>
<div id="wb_Text6" style="position:absolute;left:445px;top:265px;width:112px;height:24px;text-align:center;z-index:9;">
<span style="color:#000000;font-family:'Trebuchet MS';font-size:19px;"><em>Cotizar</em></span></div>
<div id="wb_Text7" style="position:absolute;left:676px;top:480px;width:119px;height:24px;text-align:center;z-index:10;">
<span style="color:#000000;font-family:'Trebuchet MS';font-size:19px;"><em>Buscar Item</em></span></div>
<div id="wb_Image8" style="position:absolute;left:676px;top:361px;width:104px;height:104px;z-index:11;">
<a href="./BuscarItem.php" target="_blank"><img src="images/img0057.png" id="Image8" alt=""></a></div>
<div id="wb_Image7" style="position:absolute;left:201px;top:361px;width:143px;height:117px;z-index:12;">
<a href="./Devoluciones.php"><img src="images/img0086.png" id="Image7" alt=""></a></div>
<div id="wb_Text8" style="position:absolute;left:201px;top:480px;width:125px;height:24px;text-align:center;z-index:13;">
<span style="color:#000000;font-family:'Trebuchet MS';font-size:19px;"><em>Devoluciones</em></span></div>
<div id="wb_Image5" style="position:absolute;left:445px;top:553px;width:119px;height:119px;z-index:14;">
<a href="tcpdf/examples/cerrarturno.php" target="_blank"><img src="images/img0087.png" id="Image5" alt=""></a></div>
<div id="wb_Text5" style="position:absolute;left:436px;top:686px;width:119px;height:24px;text-align:center;z-index:15;">
<span style="color:#000000;font-family:'Trebuchet MS';font-size:19px;"><em>Cerrar Turno</em></span></div>
</div>
<div id="Layer1" style="position:absolute;text-align:left;left:1px;top:0px;width:100%;height:64px;z-index:23;">
<div id="wb_Image1" style="position:absolute;left:851px;top:8px;width:125px;height:50px;z-index:17;">
<a href="http://www.technosoluciones.com" target="_blank"><img src="images/header-logo.png" id="Image1" alt=""></a></div>
<div id="Html1" style="position:absolute;left:4px;top:15px;width:608px;height:33px;z-index:18">
<?php
...
?></div>
<div id="wb_JavaScript1" style="position:absolute;left:652px;top:15px;width:191px;height:28px;z-index:19;">
...
<div id="Layer2" style="position:absolute;overflow:auto;text-align:right;left:0%;top:65px;width:159px;height:93%;z-index:24;">
<div id="Layer2_Container" style="width:159px;position:relative;margin-left:auto;margin-right:0;text-align:left;">
<div id="wb_Image2" style="position:absolute;left:14px;top:10px;width:115px;height:62px;z-index:20;">
<img src="images/tslogo.png" id="Image2" alt=""></div>
<div id="wb_CssMenu1" style="position:absolute;left:4px;top:90px;width:138px;height:352px;z-index:21;">
<ul>
<li class="firstmain"><a href="./Menu.php" target="_self">Menu</a>
</li>
<li><a href="./Administrar.php" target="_self">Administrar</a>
</li>
<li><a class="withsubmenu active" href="./Ventas.php" target="_self">Ventas</a>
