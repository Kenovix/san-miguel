...
{
   background-color: transparent;
   background-image: url(images/PrintBarras_Layer1_bkgrnd.png);
...
#Button2
{
   border: 1px #A9A9A9 solid;
   background-color: transparent;
   background-image: url(images/PrintBarras_Button2_bkgrnd.png);
   background-repeat: repeat-x;
   background-position: left top;
   color: #FFFFFF;
   font-family: Arial;
...
<body>
<div id="jQueryTabs1" style="position:absolute;left:159px;top:64px;width:1167px;z-index:17;">
<ul>
<li><a href="#jquerytabs1-page-0"><span>Imprimir codigo de barras</span></a></li>
</ul>
<div style="height:707px;overflow:auto;padding:0;" id="jquerytabs1-page-0">
<iframe name="FrameCodigo" id="InlineFrame4" style="position:absolute;left:10px;top:125px;width:1143px;height:602px;z-index:5;" src="" frameborder="0"></iframe>
<div id="wb_Form1" style="position:absolute;left:241px;top:57px;width:527px;height:65px;z-index:6;">
<form name="Form1" method="post" action="printer/barcode.php" enctype="multipart/form-data" target="FrameCodigo" id="Form1">
<input type="text" id="Editbox1" style="position:absolute;left:13px;top:30px;width:267px;height:19px;line-height:19px;z-index:0;" name="TxtBusqueda" value="<?php print($Codigo); ?>" placeholder="Digite alg&#250;n dato asociado al producto">
<div id="wb_Text1" style="position:absolute;left:39px;top:9px;width:228px;height:16px;text-align:center;z-index:1;">
<span style="color:#0000FF;font-family:'Bookman Old Style';font-size:13px;"><strong><em>Código a imprimir</em></strong></span></div>
<input type="submit" id="Button2" name="BtnImprimir" value="Imprimir" style="position:absolute;left:394px;top:28px;width:118px;height:25px;z-index:2;">
<input type="number" id="Editbox2" style="position:absolute;left:309px;top:30px;width:55px;height:19px;line-height:19px;z-index:3;" name="TxtNumPages" value="1">
<div id="wb_Text2" style="position:absolute;left:293px;top:9px;width:90px;height:16px;text-align:center;z-index:4;">
<span style="color:#0000FF;font-family:'Bookman Old Style';font-size:13px;"><strong><em>Filas</em></strong></span></div>
</form>
</div>
</div>
</div>
<div id="Layer2" style="position:absolute;text-align:right;left:0px;top:0px;width:159px;height:80%;z-index:18;">
<div id="Layer2_Container" style="width:159px;position:relative;margin-left:auto;margin-right:0;text-align:left;">
<div id="wb_CssMenu1" style="position:absolute;left:6px;top:189px;width:138px;height:455px;z-index:7;">
<ul>
...
<li><a class="active" href="./PrintBarras.php" target="_self">Barras</a>
</li>
...
<div id="wb_Image11" style="position:absolute;left:24px;top:84px;width:120px;height:48px;z-index:8;">
<a href="http://www.technosoluciones.com/" target="_blank"><img src="images/img0079.png" id="Image11" alt=""></a></div>
</div>
</div>
<div id="Layer1" style="position:absolute;text-align:left;left:0px;top:0px;width:100%;height:64px;z-index:19;">
<div id="wb_Image23" style="position:absolute;left:981px;top:1px;width:125px;height:50px;z-index:9;">
<a href="http://www.technosoluciones.com" target="_blank"><img src="images/header-logo.png" id="Image23" alt=""></a></div>
<div id="Html2" style="position:absolute;left:6px;top:18px;width:627px;height:33px;z-index:10">
<?php
...
?></div>
<div id="wb_JavaScript2" style="position:absolute;left:654px;top:22px;width:191px;height:28px;z-index:11;">
