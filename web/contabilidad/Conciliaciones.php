...
#Layer1
{
   ...
   background-image: url(images/Conciliaciones_Layer1_bkgrnd.png);
...
<div id="space"><br></div>
<div id="container">
<div id="wb_Image3" style="position:absolute;left:115px;top:138px;width:320px;height:180px;z-index:44;">
<a href="./Conciliaciones.php"><img src="images/img0074.png" id="Image3" alt=""></a></div>
<div id="wb_Image2" style="position:absolute;left:0px;top:164px;width:128px;height:128px;z-index:45;">
<a href="./Egresos2.php"><img src="images/img0077.png" id="Image2" alt=""></a></div>
...
<form name="FrmArriendos" method="post" action="GastosConciliaciones.php" enctype="multipart/form-data" target="FrameMensajes" id="Form1" onsubmit="return ValidateFrmArriendos(this)">
<input type="hidden" name="TxtPagaConciliaciones" value="1">
...
?></div>
<button id="AdvancedButton1" type="button" style="position:absolute;left:378px;top:449px;width:134px;height:136px;z-index:11;" onclick="envia();" name="BtnPagaConciliacion" value="">
...
<div id="wb_Text1" style="position:absolute;left:15px;top:23px;width:255px;height:48px;text-align:center;z-index:3;">
<span style="color:#000000;font-family:'Trebuchet MS';font-size:19px;"><em>Seleccione la cuenta para la conciliación</em></span></div>
...
<option selected value="530505">Cuotas de Manejo o Sevicios</option>
<option value="2408">IVA de Servicios</option>
<option value="530505">Cobro de transferencias</option>
</select>
